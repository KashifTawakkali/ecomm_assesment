...
function BooksandMusic() {
  return (
    <>
   <Header/>
    <div>
    <div className="container pb-16  mx-auto px-8">
<h2 className="text-2xl font-medium text-gray-800 uppercase mb-6 text-center py-8">Books And Music </h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">

    <Link to="/">
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop1.jpg" alt="product 1" className="w-full h-96"/>
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative ">
            <img src="src/assets/BooksandMusic/shop2.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop3.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop4.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop5.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop6.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop7.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop8.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/BooksandMusic/shop9.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
