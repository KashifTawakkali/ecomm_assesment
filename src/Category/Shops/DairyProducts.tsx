...
<h2 className="text-2xl font-medium text-gray-800 uppercase mb-6 text-center py-8">Dairy Product Shops</h2>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">

    <Link to="/">
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop1.jpg" alt="product 1" className="w-full h-96"/>
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative ">
            <img src="src/assets/Cakeshop/shop2.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop3.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop4.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop5.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop6.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop7.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop8.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
    ...
    <div className="bg-white shadow rounded overflow-hidden group w-full h-full">
        <div className="relative">
            <img src="src/assets/Cakeshop/shop9.jpg" alt="product 1" className="w-full h-96"/>
            <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center 
            justify-center gap-2 opacity-0 group-hover:opacity-100 transition">
